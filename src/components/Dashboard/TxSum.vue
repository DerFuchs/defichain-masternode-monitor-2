  ...
  >
    ...
    <template #settings>
      ...
      <q-item v-ripple tag="label">
        ...
        <q-item-section side>
          <q-toggle v-model="settings.showSum" color="accent" />
        </q-item-section>
      </q-item>
      <!-- show separately -->
      <q-item v-ripple tag="label">
        ...
        <q-item-section side>
          <q-toggle v-model="settings.showSeparately" color="accent" />
        </q-item-section>
      </q-item>
      <!-- show bigger -->
      <q-item v-ripple tag="label">
        ...
        <q-item-section side>
          <q-toggle v-model="settings.showBigger" color="accent" />
        </q-item-section>
      </q-item>
    </template>
    <q-card-section
    ...
    <q-separator
      v-if="settings.showSeparately && user.watchedActiveMasterNodesContext.length > 1"
    />
    <q-card-section
      v-if="settings.showSeparately && user.watchedActiveMasterNodesContext.length > 1"
      class="q-px-none"
      ...
      <q-list class="row text-center">
        ...
        >
          <q-item-section>
            ...
            <q-item-label caption class="ellipsis">{{ masternode.name }}</q-item-label>
          </q-item-section>
        </q-item>
      </q-list>
    </q-card-section>
